(function() {
  var DOM_API, HEADER_TAGS, buildHierarchy, buildSectionIndex, getHeadersAndText;
  ...
  buildSectionIndex = function(siteHierarchy) {
    var queue, section, sectionIndex, stack;
    queue = [siteHierarchy];
  ...
  this.onmessage = (function(_this) {
    return function(event) {
      var pages, sectionIndex, siteHierarchy;
